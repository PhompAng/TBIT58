...
return array(
	...
	*/
	...
	"after"                => ":attribute ต้องอยู่หลัง เท่านั้น",
	...
	"before"               => ":attribute ต้องอยู่หลัง :date เท่านั้น",
	"between"              => array(
	...
	"boolean"              => ":attribute ต้องกรอกเป็น True หรือ False เท่านั้น",
	...
	"email"                => ":attribute ต้องเป็นรูปแบบอีเมล์ที่ถูกต้อง",
	"exists"               => "ตัวเลือก :attribute ไม่ถูกต้อง",
	"image"                => ":attribute ​​​​​ต้องเป็นภาพเท่านั้น",
	"in"                   => "ตัวเลือก :attribute ไม่ถูกต้อง",
	"integer"              => ":attribute ต้องเป็นจำนวนเต็มเท่านั้น",
	"ip"                   => ":attribute ต้องเป้นรูปแบบ IP Address ที่ถูกต้อง",
	"max"                  => array(
	...
	"min"                  => array(
		...
		"file"    => ":attribute ต้องมีขนาดใหญ้กว่า :min kb.",
		"string"  => ":attribute ต้องมีค่ามากกว่า :min ตัวอักษร.",
	...
	"required_with"        => ":attribute จำเป็นต้องกรอกเมื่อ มีการกรอก :values",
	"required_with_all"    => ":attribute จำเป็นต้องกรอกเมื่อ มีการกรอก :values",
	"required_without"     => ":attribute จำเป็นต้องกรอกเมื่อ ไม่มีการกรอก :values",
	"required_without_all" => ":attribute จำเป็นต้องกรอกเมื่อ ไม่มีการกรอก :values",
