                ...
                <div class="courses-slider">
                        ...
                        <div class="subject-item card">
                            ...
                            <div class="btn-group" role="group" >
                              <a class="btn btn-primary btn-sm" href="{{ URL::to('/sheets/Programming58.pdf')}}"><span class="glyphicon glyphicon-download-alt"></span> Programming</a>
                              <a class="btn btn-primary btn-sm" href="{{ URL::to('/sheets/Mathematic58.pdf')}}"><span class="glyphicon glyphicon-download-alt"></span> Math</a>
                            </div>
                </div>
            </div>
        </div>
